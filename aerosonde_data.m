...
aerosonde.osw = 0.75;
% pieaR, constant = \pi *e *AR where the wing aerosondepect ratio AR=b^2/S
...
%%% INERTIA %%%
% Empty aircraft maerosondes (zero-fuel)
aerosonde.mempty = 8.5; % kg
% Gross aircraft maerosondes (full fuel tank)
